...
@section('title', 'creating new fuel')
@section('sidebar')
@parent
@endsection
@section('content')
<form action="{{ route('fuels.store') }}" class="form container" method="POST" enctype="multipart/form-data">
    @csrf

    <h1 class="title is-3">ADD FUEL</h1>
