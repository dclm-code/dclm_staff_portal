...
@section('title', 'creating new location')
@section('sidebar')
@parent
@endsection
@section('content')
<form action="{{ route('locations.store') }}" class="form container" method="POST" enctype="multipart/form-data">
    @csrf

    <h1 class="title is-3">ADD LOCATION</h1>
