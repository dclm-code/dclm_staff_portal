...
@section('title', 'creating new promotion')
@section('sidebar')
@parent
@endsection
@section('content')
<form action="{{ route('promotions.store') }}" class="form container" method="POST" enctype="multipart/form-data">
    @csrf

    <h1 class="title is-3">ADD PROMOTION</h1>
