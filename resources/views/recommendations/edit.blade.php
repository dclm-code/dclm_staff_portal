...
@section('title', 'Editing Recommendation')
@section('sidebar')
@parent
@endsection
@section('content')
<form action="{{ route('recommendations.update',$recommendation->id) }}" class="form container" method="PUT" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <h1 class="title is-3">EDIT RECOMMENDATION</h1>
