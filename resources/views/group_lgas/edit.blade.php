...
@section('title', 'Editing Group_lga')
@section('sidebar')
@parent
@endsection
@section('content')
<form action="{{ route('group_lgas.update',$group_lga->id) }}" class="form container" method="PUT" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <h1 class="title is-3">EDIT GROUP LGA</h1>
