...
@section('title', 'creating new leave_remark')
@section('sidebar')
@parent
@endsection
@section('content')
<form action="{{ route('leave_remarks.store') }}" class="form container" method="POST" enctype="multipart/form-data">
    @csrf

    <h1 class="title is-3">ADD LEAVE REMARK</h1>
