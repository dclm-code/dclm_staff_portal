...
@section('title', 'Editing Next_of_kin')
@section('sidebar')
@parent
@endsection
@section('content')
<form action="{{ route('next_of_kins.update',$next_of_kin->id) }}" class="form container" method="PUT" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <h1 class="title is-3">EDIT NEXT OF KIN</h1>
