...
@section('title', 'Editing Staff')
@section('sidebar')
@parent
@endsection
@section('content')
<form action="{{ route('staff.update',$staff->id) }}" class="form container" method="PUT" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <h1 class="title is-3">EDIT STAFF</h1>
