...
@section('title', 'Editing Qualification')
@section('sidebar')
@parent
@endsection
@section('content')
<form action="{{ route('qualifications.update',$qualification->id) }}" class="form container" method="PUT" enctype="multipart/form-data">
    @method('PUT')
    @csrf
    <h1 class="title is-3">EDIT QUALIFICATION</h1>
